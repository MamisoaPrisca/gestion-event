...
@AllArgsConstructor
@Builder
@Table(name = "v_all_prix_achat")
public class ViewAllPrixAchat {
    @Id
    private long id ;
    @Column
    ...
    public String getLibelle(){
        String categorie = (this.categorie!=null && this.categorie.length()>0) ? (" ("+this.categorie+")"):"";
        return produit+" "+(variante==null?"": variante) +" - "+conditionnement +" - "+ NumberUtil.formaterNumbre(montant)+" Ar" + categorie;
    }
}
